...
const KEYS = {
  TOKEN: '@solapp:token',
  USER: '@solapp:user',
  ONBOARDING_COMPLETED: '@solapp:onboarding_completed',
  FIRST_TIME_USER: '@solapp:first_time_user',
  BIOMETRIC_ENABLED: '@solapp:biometric_enabled',
  BIOMETRIC_CREDENTIALS: '@solapp:biometric_credentials',
  TWO_FA_ENABLED: '@solapp:2fa_enabled',
  RECOVERY_CODES: '@solapp:recovery_codes',
};
